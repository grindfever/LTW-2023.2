...
<!DOCTYPE html>
 ...
 <body>
  ...
  <nav id="main_menu">
    ...
    <?php //if($_SESSION['usertype'] == "agent" || $_SESSION['usertype'] == "admin"){
    ?>
  ...
  <div class = "ticket-form">
    ...
    <div class = "ticket-info">
      <div class="ticket-input-box">
        ...
        <input type = "text" name="title" value="<?php echo $ticket['ticket_title']; ?>">
      </div>
      <?php
      ...
      <div class="ticket-input-box">
        ...
        <input type="text" id="ticket_priority" name="priority" value=<?php echo $ticket['ticket_priority']; ?>>
      </div>
      <?php
        }
      ?>
      ...
      <div class="ticket-input-box">
        ...
        <input type="text" id="ticket_hashtag" name="hashtag" value=<?php echo $ticket['ticket_hashtag']; ?>>
      </div>
      <?php
        }
      ?>
       ...
       <select name="department" id="department">
        ...
        <option value="Costomer Service">Costomer Service</option>
      ...
      <div class = "description-input-box">
        <label><b>Description</b></span>
        <textarea class = "description-text" id="description_text" name = "description"><?php echo $ticket['ticket_description']; ?></textarea>
      </div>
