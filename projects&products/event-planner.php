...
<div class="projprod">
  ...
  <p>The Event Planner is a powerful tool designed to assist you in organizing and managing your events seamlessly. Whether you are planning a small gathering, a corporate conference, or a grand celebration, our Event Planner provides you with the necessary features and resources to ensure a successful and memorable event.</p>
  <h2>Key Features</h2>
  ...
  <h2>How It Works</h2>
  <p> The Event Planner simplifies the event planning process. To get started, sign up for an account and create your event. Customize the event details, such as the date, time, venue, and theme. Manage your guest list by sending invitations and tracking RSVPs. Keep track of tasks and deadlines with the integrated task management feature. Monitor your budget and expenses to ensure you stay on track. Collaborate with vendors and event team members to streamline the planning process. Promote your event using the built-in marketing tools and communicate updates to your attendees in real-time.</p>
  ...
  <p>If you have any inquiries or require assistance with the Event Planner, please don't hesitate to contact our support team at support@eventplanner.com or call us at +1-123-456-7890. We are here to make your event planning journey a breeze!</p>
</div>
<footer>
